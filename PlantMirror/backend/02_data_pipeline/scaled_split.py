...
def load_and_prepare_episodic(
    ...
    print("\n  OK train4 was NEVER seen during training")
    print("  OK train4 was NOT used for fitting the scaler")
    print("  OK train3_last70% is ONLY for validation (never trained on)")
    print("  OK If RMSE on train4 ≈ RMSE on val → model learned causal relationships")
    print("  OK If RMSE on train4 >> RMSE on val → model overfit to train1-3 patterns")
    print("="*70)
...
if __name__ == "__main__":
    ...
    print("\nOK Data ready for Transformer training!")
