"""
plot_lstm.py — Generate all diagnostic plots for the trained LSTM model.

Plots saved to outputs/lstm_plant/plots/:
...
CKPT_DIR  = ROOT / "outputs" / "lstm_plant"
...
# ── Load plant model ──────────────────────────────────────────────────────────
ckpt = torch.load(CKPT_DIR / "lstm_plant.pt", map_location=DEVICE)
...
print(f"  Loaded LSTMPlant (epoch {epoch}, val_loss={val_str})")
