"""
run_eval_causal.py — Evaluate Transformer (causal) checkpoint.
...
Run:
    python 04_evaluate/run_eval_causal.py
"""
...
OUT_DIR    = ROOT / "outputs/transformer/causal"
MODEL_NAME = "Transformer (causal)"
